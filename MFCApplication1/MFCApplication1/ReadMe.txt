...
DlgProxy.h、DlgProxy.cpp - 自动化对象
    这些文件包含 CMFCApplication1DlgAutoProxy 类。此类称为对话框的自动化代理类，因为它负责公开可供自动化控制器用于访问对话框的自动化方法和属性。这些方法和属性并不是直接从对话框类公开，因为对于基于模式对话框的 MFC 应用程序而言，将自动化对象与用户界面分离开来更加清晰便捷。
